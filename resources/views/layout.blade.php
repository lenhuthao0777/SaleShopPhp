					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i>+84 000 000 00</a></li>
				...
				<div class="row">
					...
					<form action="{{URL::to('/tim-kiem')}}" method="POST">
						...
						<div class="search_box pull-right">
							...
							<input type="submit" style="margin-top:0;color:#fff" name="search_item" class="btn btn-primary btn-sm" value="Tìm Kiếm">
						</div>
					</form>	
					</div>
				</div>
